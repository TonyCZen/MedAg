...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Queste linee contengono i messaggi di errore predefiniti usati dal
    | validator di Laravel. Alcune regole hanno più versioni come quelle
    | legate alle dimensioni. Puoi modificare i messaggi secondo necessità.
    |
    */
    ...
    'between' => [
        ...
        'file' => 'Il file :attribute deve avere dimensione tra :min e :max kilobyte.',
    ...
    'doesnt_contain' => 'Il campo :attribute non deve contenere i seguenti valori: :values.',
    ...
    'min' => [
        ...
        'file' => 'Il file :attribute deve avere almeno :min kilobyte.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore di :attribute fornito è stato compromesso in una violazione dati. Scegli un altro :attribute.',
    ],
    ...
    'unique' => 'Il valore di :attribute è già stato preso.',
    ...
    |--------------------------------------------------------------------------
    |
    | Qui puoi specificare messaggi personalizzati per singoli attributi
    | usando la sintassi "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Qui puoi sostituire i nomi dei campi con etichette più leggibili
    | come "Indirizzo E-Mail" invece di "email".
    |
    */
