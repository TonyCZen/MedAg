            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" style="display: flex; align-items: center; text-decoration: none; gap: 10px;">
                        <i class="bi bi-heart-pulse-fill" style="font-size: 30px !important; color: #0284c7 !important; display: inline-block !important;"></i>
                        <span style="font-weight: bold; color: red; font-size: 20px;">MedAg</span>
                    </a>
                </div>
